...
<nav class="navbar navbar-expand-md navbar-light fixed-top border-secondary shadow-lg bg-white">
    ...
    <div class="container-lg my-5">
        <br/><br/>  
        <h3 class="fw-bold display-6 text-center"><?php echo htmlspecialchars($car['name']); ?></h3>
        <div class="row my-4">
            <div class="col-md-6 car-images">
                <h5>Images:</h5>
                <img src='data:image/jpeg;base64,<?php echo base64_encode($car['image']); ?>' alt="Main Image">
                <img src='data:image/jpeg;base64,<?php echo base64_encode($car['image1']); ?>' alt="Image 1">
                <img src='data:image/jpeg;base64,<?php echo base64_encode($car['image2']); ?>' alt="Image 2">
                <img src='data:image/jpeg;base64,<?php echo base64_encode($car['image3']); ?>' alt="Image 3">
            </div>
