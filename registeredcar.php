...
<div class="container-lg my-5">
    <br/><br/>   
    <h3 class="fw-bold display-6 text-center"> Registered Cars</h3>
    <div class="row my-4 align-items-center justify-content-center g-4">
        ...
        $select = mysqli_query($jcon, "SELECT * FROM cars WHERE email='$email'"); 

        if (!$select) {
            die("Query failed: " . mysqli_error($jcon));
        }
